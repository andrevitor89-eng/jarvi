...
| `ARCHITECTURE.md`, `*_RUNBOOK.md`, `STRIPE_SETUP.md`, `PRODUCTION_PLAN.md`, `SETUP_NOVO_COMPUTADOR.md`, `WHATSAPP_TASKS.md`, [ERROR_SWEEP_2026-09-10.md](ERROR_SWEEP_2026-09-10.md) | Ops / engenharia **já existentes** — ficam na raiz de `docs/` neste passo | Como subir WhatsApp em produção; varredura de erros 2026-09-10 | Contrato de UI |
