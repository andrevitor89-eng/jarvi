...
| `ARCHITECTURE.md`, `*_RUNBOOK.md`, `STRIPE_SETUP.md`, `PRODUCTION_PLAN.md`, `SETUP_NOVO_COMPUTADOR.md`, `WHATSAPP_TASKS.md`, [QA_FIX_PLAN.md](QA_FIX_PLAN.md) | Ops / engenharia **já existentes** — ficam na raiz de `docs/` neste passo | Como subir WhatsApp em produção; plano de correção QA ao vivo | Contrato de UI |
