...
|-----------------|-----------|---------|-------------------|
| [product/](product/) | O que a Jarvi é (superfícies, job do produto) | App de tarefas; web + marketing + mobile; [Instagram → tarefa](product/instagram-tarefas.md) | Spec de componente, bans de CSS |
